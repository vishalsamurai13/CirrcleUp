...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ title, description }) => {
  return (
    <div className="relative w-[914px] h-[341px] flex flex-col justify-center items-center px-10 text-center border-2 border-[#28B673]">
      {/* Corner Squares */}
      ...
      {/* Main Content */}
      <h3 className="text-[32px] font-bold text-[#1C1C30] mb-6">{title}</h3>
      <p className="text-[18px] text-[#1C1C30] leading-[32px] max-w-[720px]">
        {description}
      </p>
    </div>
  );
