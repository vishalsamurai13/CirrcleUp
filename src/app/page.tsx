...
const TestimonialsCarousel = () => {
  ...
  return (
    <div className="bg-[#eeeeee] pt-16 pb-64 relative z-0">
      <div className="flex flex-col gap-12 pt-12 pb-12 ml-[285px] mr-[285px] overflow-hidden">
        {/* Header */}
    ...
    <div className="text-black bg-white min-h-screen overflow-x-hidden">
      ...
      <div className='h-full'>
        ...
        <div className='ml-[285px] mr-[285px] mt-32 space-y-6 pr-16 pl-16 pb-16'>
          <h1 className='w-full text-[50px] text-[#29B573] leading-[68px] font-light'>
          Solving Leadership at the Moments That Count !
          </h1>
          <h2 className='w-full text-[18px] leading-[22px]'>
          We help companies and leaders tackle the questions that define success in a fast-moving world.
          </h2>
          <p className='font-semibold text-[16px]'>How do I ...</p>

          <div className='grid grid-cols-3 gap-8 space-y-8 mt-12'>

            <div className='flex flex-col items-start w-[212px] gap-4  text-[24px] text-[#29B573]'>
            ...
            <div className='flex flex-col items-start w-[250px] gap-4  text-[24px] text-[#29B573]'>
              <Link href='/Capabilities/Succession'>
        ...
        <div className='w-full bg-[#D9D9D9] mt-24 '>
          <div className='flex gap-12 pt-12 pb-12 ml-[285px] mr-[285px] pr-16 pl-16 items-center'>
              <div className="w-[500px] h-[220px] relative rounded-full overflow-hidden">
                <Image
              ...
              <div className='flex flex-col gap-4 justify-between h-[220px]'>
                <p className='font-semibold text-[20px]'>&quot;Being a chemist, I see consultancy as a business catalyst: it accelerates transformations while at the same time raising the appeak of the client and their product&quot;</p>
                <div className='flex flex-col'>
                  <p className='text-[14px] font-bold'>James Hawkins Woodsen</p>
                  <p className='text-[14px]'>Former Associate</p>
                  <p className='text-[14px]'>Dubai Office, UAE</p>
                </div>
              </div>
          </div>
        </div>
          ...
          <div className='flex flex-col gap-12 pt-12 pb-12 ml-[285px] mr-[285px] pr-16 pl-16'>
            ...
            <div className='flex justify-between mt-12'>
              <div className='w-[288px] flex flex-col items-center'>
                <h1 className='text-[#29B573] text-[124px] font-bold'>35<span className='text-[73px] font-medium'>+</span></h1>
              ...
              <div className='w-[288px] flex flex-col items-center'>
                <h1 className='text-[#29B573] text-[124px] font-bold'>92<span className='text-[73px] font-medium'>%</span></h1>
                <p className='text-[18px] text-[#29B573] text-center'>Repeat client engagement rate across key verticals</p>
              </div>
              <div className='w-[288px] flex flex-col items-center'>
                <h1 className='text-[#29B573] text-[124px] font-bold'>120<span className='text-[73px] font-medium'>+</span></h1>
        ...
        {/* Event Highlights */}
        <div className="bg-[#eeeeee] px-20 relative z-0">
