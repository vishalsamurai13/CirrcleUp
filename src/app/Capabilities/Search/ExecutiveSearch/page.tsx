    ...
    <div className='text-black bg-white min-h-screen overflow-x-hidden'>
        ...
        <div className='pt-[120px] h-full'>
            ...
            <div className='ml-[285px] mr-[285px] mt-12 space-y-4 pr-16 pl-16'>
                <h1 className='font-bold text-[46px] leading-[60px]'>Powering Business Momentum with the Right Leadership</h1>
                <h2 className='font-medium text-[24px] leading-[40px] text-[#28B673]'>Cirrcle Up delivers tailored executive search services across the C-suite—designed to drive transformation, innovation, and cultural cohesion.</h2>
            </div>
            ...
            <div className='ml-[285px] mr-[285px] mt-12 pr-16 pl-16'>
                <p className='text-[18px] leading-[23px]'>Great leadership doesn’t just react—it anticipates, pivots, and unlocks value. At Cirrcle Up, our Executive Search practice is built to identify leaders across functions who can do exactly that. Whether you need a growth-oriented CFO, a digital-first CMO, or a transformational CHRO, we make sure you don’t just fill a role—you future-proof it.
                    <br/><br/>
