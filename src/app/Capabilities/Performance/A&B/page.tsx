...
const whatWeOfferItems = [
  {
    heading: "●      Readiness for new roles or promotions",
  },
  {
    heading: "●      Leadership potential across internal talent",
  },
  {
    heading: "●      Strategic and cultural fit for new hires",
  },
  {
    heading: "●      Comparative benchmarking across functions or industry peers",
  },
];
    ...
    <div className='text-black bg-white min-h-screen overflow-x-hidden'>
        ...
        <div className='pt-[120px] h-full'>
            ...
            <div className='ml-[285px] mr-[285px] mt-12 space-y-4 pr-16 pl-16'>
                <h1 className='font-bold text-[46px] leading-[60px]'>Leadership Insights That Drive Better Decisions</h1>
                <h2 className='font-medium text-[24px] leading-[40px] text-[#28B673]'>Cirrcle Up offers customized leadership assessments and benchmarking tools that reveal readiness, gaps, and opportunities across your top talent.</h2>
            </div>
            ...
            <div className='ml-[285px] mr-[285px] mt-12 pr-16 pl-16'>
                <p className='text-[18px] leading-[23px]'>You can’t optimize what you don’t measure. And in leadership, gut feel alone isn’t enough. Our Assessment & Benchmarking services combine psychometric science, role-based evaluations, and strategic fit modeling to help you identify, grow, and retain your top leaders.
                    <br /><br />
